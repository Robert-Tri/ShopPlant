...
public class createPlantsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String thongbao = "Add Plant successfully!!";
            String thongbao2 = "Add Plant Error!!";
            boolean check = PlantDAO.insertPlant(name, price, imgpath, description, status, CategoriesDAO.getCateIDByName(cateName));
            if (check) {
                request.setAttribute("report", thongbao);
                request.getRequestDispatcher("createPlants.jsp").forward(request, response);
            } else {
